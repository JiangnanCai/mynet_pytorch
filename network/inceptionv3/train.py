...
# 训练阶段 -----------------------------------------------------------------------------------------------------------
net = InceptionV3(in_channels=3, num_classes=5, aux_logits=True, init_weight=True)
net.to(device)
