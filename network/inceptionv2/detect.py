...
img = Image.open(r'/home/cai/Documents/Inception/archive(1)/dataset/test/e8926d6d85.jpg')
plt.imshow(img)
...
model = InceptionV2(in_channels=3, num_classes=5, aux_logits=False)
model_weight = r'/home/cai/Documents/Inception/inception_v2/inception_v2.pth'
