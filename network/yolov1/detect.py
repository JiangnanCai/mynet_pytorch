...
class YOLODetector:
    def __init__(self,
        ...
        self.S, self.B, self.C = self.yolo.num_grids, self.yolo.num_bboxes, self.yolo.num_classes
        ...
        # Warm up.
        dummy_input = Variable(torch.zeros((1, 3, 448, 448))).cuda()
        for i in range(10):
    ...
    def detect(self, image_bgr, image_size=448):
        ...
        # Apply non-maximum suppression for boxes of each class.
        ...
        # Post-process for box, labels, probs.
        ...
        for b in range(boxes_normalized.size(0)):
            ...
            x1, x2 = w * box_normalized[0], w * box_normalized[2]  # denormalize x with image width.
            y1, y2 = h * box_normalized[1], h * box_normalized[3]  # denormalize y with image height.
