...
class Yolov1Loss(Module):
    def __init__(self, num_grids, num_bboxes=2, num_classes=20, i_coord=5.0, i_noobj=0.5):
    ...
    def forward(self, pred_tensor, target_tensor):
        ...
        # 网格含目标的bbox集合， [n_coord x B, 5=(x, y, w, h, conf)]
        bbox_pred = coord_pred[:, :5 * self.B].contiguous().view(-1, 5)
